-- DigiGram: Ultra-Robust Seed (Fixes ID and Parent conflicts)
...
ON CONFLICT (slug) DO UPDATE SET id = EXCLUDED.id, name_bn = EXCLUDED.name_bn;
...
ON CONFLICT (slug) DO UPDATE SET id = EXCLUDED.id, parent_id = EXCLUDED.parent_id, name_bn = EXCLUDED.name_bn;
...
VALUES 
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444441', true),
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444442', true),
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444443', true),
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', true),
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444445', false),
('22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444446', true)
ON CONFLICT (location_id, service_id) DO UPDATE SET is_active = EXCLUDED.is_active;
